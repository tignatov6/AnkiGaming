...
![alt text](.readme_resources/select_interpreter.png)

5. Выбрать рекомендованый вариант с (venv)

![alt text](.readme_resources/select_interpreter2.png)
...
![alt text](.readme_resources/Add_file_and_Upload_Files.png)
...
![alt text](.readme_resources/source_control.png)

5. Теперь на кнопку Pull

![alt text](.readme_resources/pull.png)
